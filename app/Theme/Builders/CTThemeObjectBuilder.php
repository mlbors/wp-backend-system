<?php
/**
 * WP System - CTThemeObjectBuilder - Concrete Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
/*********************************************/
/********** CT THEME OBJECT BUILDER **********/
/*********************************************/

class CTThemeObjectBuilder extends AbstractThemeObjectBuilder
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        return $this->_container->makeWith(CTThemeObject::class, ['entity' => $entity]);
    }
}