<?php
/**
 * WP System - WPDBRedirectionsContextFactory - Concrete Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
use App\Theme\Contexts\WPDBRedirectionsContext as WPDBRedirectionsContext;

/*******************************************************/
/********** WPDB REDIRECTIONS CONTEXT FACTORY **********/
/*******************************************************/

class WPDBRedirectionsContextFactory extends AbstractContextFactory
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        return $this->_container->makeWith(WPDBRedirectionsContext::class, ['entityFactory' => $this->_entityFactory, 'requestService' => $requestService]);
    }
}