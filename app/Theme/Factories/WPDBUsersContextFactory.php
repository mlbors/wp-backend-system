<?php
/**
 * WP System - WPDBUsersContextFactory - Concrete Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
use App\Theme\Contexts\WPDBUsersContext as WPDBUsersContext;

/************************************************/
/********** WPDB USERS CONTEXT FACTORY **********/
/************************************************/

class WPDBUsersContextFactory extends AbstractContextFactory
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        return $this->_container->makeWith(WPDBUsersContext::class, ['entityFactory' => $this->_entityFactory, 'requestService' => $requestService]);
    }
}