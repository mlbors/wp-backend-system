<?php
/**
 * WP System - WPDBCPTContextFactory - Concrete Class
 *
 * @since       12.01.2018
 * @version     1.0.0.0
 * @author      mlbors
...
use App\Theme\Contexts\WPDBCPTContext as WPDBCPTContext;

/**********************************************/
/********** WPDB CPT CONTEXT FACTORY **********/
/**********************************************/

class WPDBCPTContextFactory extends AbstractContextFactory
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        return $this->_container->makeWith(WPDBCPTContext::class, ['entityFactory' => $this->_entityFactory, 'requestService' => $requestService]);
    }
}