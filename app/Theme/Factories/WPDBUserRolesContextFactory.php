<?php
/**
 * WP System - WPDBUserRolesContextFactory - Concrete Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
use App\Theme\Contexts\WPDBUserRolesContext as WPDBUserRolesContext;

/*****************************************************/
/********** WPDB USER ROLES CONTEXT FACTORY **********/
/*****************************************************/

class WPDBUserRolesContextFactory extends AbstractContextFactory
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        return $this->_container->makeWith(WPDBUserRolesContext::class, ['entityFactory' => $this->_entityFactory, 'requestService' => $requestService]);
    }
}