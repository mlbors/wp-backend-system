<?php
/**
 * WP System - WPDBAPISContextFactory - Concrete Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
use App\Theme\Contexts\WPDBAPISContext as WPDBAPISContext;

/***********************************************/
/********** WPDB APIS CONTEXT FACTORY **********/
/***********************************************/

class WPDBAPISContextFactory extends AbstractContextFactory
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        return $this->_container->makeWith(WPDBAPISContext::class, ['entityFactory' => $this->_entityFactory, 'requestService' => $requestService]);
    }
}