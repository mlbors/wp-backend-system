<?php
/**
 * WP System - WPDBOptionsContextFactory - Concrete Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
use App\Theme\Contexts\WPDBOptionsContext as WPDBOptionsContext;

/**************************************************/
/********** WPDB OPTIONS CONTEXT FACTORY **********/
/**************************************************/

class WPDBOptionsContextFactory extends AbstractContextFactory
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        return $this->_container->makeWith(WPDBOptionsContext::class, ['entityFactory' => $this->_entityFactory, 'requestService' => $requestService]);
    }
}