<?php
/**
 * WP System - PostsRepository - Abstract Class
 *
 * @since       12.01.2018
 * @version     1.0.0.0
 * @author      mlbors
...
class PostsRepository extends AbstractRepository
{
    ...
    {
        parent::__construct($contextFactory, $themeObjectBuilder, $requestService, 'post');
    }
    ...
    public function check(IConstraints $constraints)
    {
        $action = 'check' . ucfirst($this->_type) . $constraints->args['method'];
