<?php
/**
 * WP System - TaxonomiesRepository - Abstract Class
 *
 * @since       12.01.2018
 * @version     1.0.0.0
 * @author      mlbors
...
class TaxonomiesRepository extends AbstractRepository
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        parent::__construct($contextFactory, $themeObjectBuilder, $requestService, 'taxonomy');
    }
}