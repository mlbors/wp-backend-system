<?php
/**
 * WP System - CPTRepository - Abstract Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
class CPTRepository extends AbstractRepository
{
    /*******************************/
    /********** CONSTRUCT **********/
    /*******************************/
    ...
    {
        parent::__construct($contextFactory, $themeObjectBuilder, $requestService, 'cpt');
    }
