<?php
/**
 * WP System - OptionThemeObject - Concrete Class
 *
 * @since       2018.01.12
 * @version     1.0.0.0
 * @author      mlbors
...
use App\Theme\Interfaces\IOption as IOption;
...
class OptionThemeObject extends AbstractThemeObject implements IOption
{
    /*******************************/
    /********** ATTRIBUTS **********/
    /*******************************/
    ...
    public function __construct(IEntity $entity, IStateFactory $stateFactory)
    {
        ...
        $this->_setOptionValues($stateFactory);     
    }
    ...
    protected function _setOptionValues(IStateFactory $stateFactory)
    {   
